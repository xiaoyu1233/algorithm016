...
if __name__ == '__main__':
	# 使用英文路径，中文路径读不进来
    # imgs_path = r'D:\AleetcodeOn\algorithm016\Week_03\test\img'  #图片路径
    # xmls_path = r'D:\AleetcodeOn\algorithm016\Week_03\test\xml' #xml路径
    # retangele_img_path = r'D:\AleetcodeOn\algorithm016\Week_03\test\after_xml' #保存画框后图片的路径
    # imgs_path = r'F:\AdatabaseForGraduation\img\circle'  #图片路径
    # xmls_path = r'F:\AdatabaseForGraduation\voc\circle_voc' #xml路径
    # retangele_img_path = r'F:\AdatabaseForGraduation\img_after\circle_after' #保存画框后图片的路径
    ...
    imgs_path = r'F:\AdatabaseForGraduation\img\scratch'  #图片路径
    xmls_path = r'F:\AdatabaseForGraduation\voc\scratch_voc' #xml路径
    retangele_img_path = r'F:\AdatabaseForGraduation\img_after\scratch_after' #保存画框后图片的路径
